...
export function LowesTestimonialsSection() {
  ...
  return (
    <section className="py-12 md:py-16 bg-background">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-sm font-semibold text-[#004990] uppercase tracking-wide mb-2">
          Testimonials
        </p>
        ...
        <p className="text-muted-foreground mb-8">
          Real reviews from real homeowners who trusted Lowe&apos;s with their installation projects.
        </p>
