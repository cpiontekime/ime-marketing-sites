...
export function AceHowItWorksSection() {
  return (
          ...
          {steps.map((step) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="w-12 h-12 rounded-lg bg-[#fde8ec] flex items-center justify-center">
                  <step.icon className="w-6 h-6 text-[#d40029]" />
                </div>
