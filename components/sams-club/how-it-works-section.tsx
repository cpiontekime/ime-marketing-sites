...
export function SamsClubHowItWorksSection() {
  return (
    <section className="w-full py-12 md:py-16 bg-background">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-sm font-semibold text-[#0060a9] uppercase tracking-wide mb-2">
          How It Works
        </p>
          ...
          {steps.map((step) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="w-12 h-12 rounded-lg bg-[#e0f0ff] flex items-center justify-center">
                  <step.icon className="w-6 h-6 text-[#0060a9]" />
                </div>
